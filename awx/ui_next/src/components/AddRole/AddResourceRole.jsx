...
function AddResourceRole({ onClose, onSave, roles, i18n, resource }) {
  console.log(roles, 'roles')
  const [selectedResource, setSelectedResource] = useState(null);
  const [selectedResourceRows, setSelectResourceRows] = useState([]);
  ...
  const handleResourceCheckboxClick = user => {
    ...
    if (selectedIndex > -1) {
      ...
      selectedResourceRows(stateToUpdate);
    } else {
      setSelectResourceRows([...selectedResourceRows, user]);
    }
  };
